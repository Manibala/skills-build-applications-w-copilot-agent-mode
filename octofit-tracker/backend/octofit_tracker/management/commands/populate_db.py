...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        marvel_team = {
            'name': 'Marvel',
            'members': ['Iron Man', 'Captain America', 'Thor', 'Hulk', 'Black Widow']
        }
        dc_team = {
            'name': 'DC',
        ...
        activities = [
            ...
            {'user': 'Batman', 'activity': 'Swimming', 'duration': 45},
            {'user': 'Thor', 'activity': 'Cycling', 'duration': 60},
        ]
        leaderboard = [
        ...
        workouts = [
            {'user': 'Hulk', 'workout': 'Strength', 'suggestion': 'Heavy Lifting'},
            {'user': 'Wonder Woman', 'workout': 'Cardio', 'suggestion': 'HIIT'},
        ]
